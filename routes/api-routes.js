    ...
    data = [
      {
        ...
        images: ["./images/register.gif", "./images/game.gif"]
      },
      {
        title: "Tweet Translator",
        description:
          "Project 1 for Georgia Tech Full Stack Web Development Bootcamp. Utilizes the Twitter and Google Translate APIs to send translated messages to twitter. Look me up on Twitter @consoleLogdog to see the tweet! (Please use responsibly as the dev credentials are through my account!)",
        technologies: [],
        links: {
          github: "https://github.com/lrminer/translate-tweet-app",
          deployed: "https://translate-a-tweet.herokuapp.com/"
        },
        images: ["./images/TranslateATweet.PNG"]
      },
      {
        title: "Budget App",
